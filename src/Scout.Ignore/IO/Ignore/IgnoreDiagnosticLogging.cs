...
internal static class IgnoreDiagnosticLogging
{
    ...
    private const string IgnoreStackSourceFile = "src/Scout.Ignore/IO/Ignore/IgnoreStack.cs";
    private const string WalkSourceFile = "src/Scout.Ignore/IO/Ignore/Walk.cs";
