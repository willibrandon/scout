...
native differential coverage for look-around patterns. Standard and vimgrep
output, including context, passthru, replacement, multiline, and multiline
inverted records, is also covered by pinned native differentials.
