...
/// <summary>
/// Identifies the requested input transcoding mode for search bytes.
/// </summary>
public enum SearchEncodingKind
{
    /// <summary>
    /// Sniff byte-order marks and otherwise keep bytes unchanged.
    /// </summary>
    Auto,

    /// <summary>
    /// Disable byte-order mark sniffing and keep bytes unchanged.
    /// </summary>
    None,
