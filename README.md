...
> **Status:** v0.4.5, tracking ripgrep 15.1.0 (commit `4857d6fa67`). Functional and fully
> tested — 3,636 tests pass on all six supported platforms. The release workflow publishes NuGet
...
own integration tests and the regex and encoding conformance corpora run alongside it — 3,636
