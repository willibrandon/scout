...
public sealed partial class PinnedConfigurationTests
{
    ...
    public void HyperfineBenchSuiteCoversReleaseGateWorkloads()
    {
        ...
        Assert.Contains("check_time_gate_combined", script, StringComparison.Ordinal);
        ...
        Assert.Contains("combined_hyperfine_json_metric_median", script, StringComparison.Ordinal);
        ...
        Assert.Contains("repeats only that workload up to two times", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("Peak RSS", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("large bounded Unicode-class workload uses five runs and five", readme, StringComparison.Ordinal);
