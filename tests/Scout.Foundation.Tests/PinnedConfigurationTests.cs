...
public sealed partial class PinnedConfigurationTests
{
    ...
    public void HyperfineBenchSuiteCoversReleaseGateWorkloads()
    {
        ...
        Assert.Contains("GATE_LINE_REGEX_RUNS=\"6\"", script, StringComparison.Ordinal);
        Assert.Contains("GATE_LINE_REGEX_WARMUP=\"6\"", script, StringComparison.Ordinal);
        ...
        Assert.Contains("gate_cold_warmup", script, StringComparison.Ordinal);
        ...
        Assert.Contains("-- %s retry %s/%s --", script, StringComparison.Ordinal);
        ...
        Assert.Contains("after the initial attempt and", script, StringComparison.Ordinal);
        ...
        Assert.Contains("ABBA/BAAB", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("script first measures rg and", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("Only the leading", readme, StringComparison.Ordinal);
        Assert.Contains("once per cycle", readme, StringComparison.Ordinal);
        Assert.Contains("neither measurement inherits", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("(\"rg\", \"scout\", \"scout\", \"rg\")", interleaved, StringComparison.Ordinal);
        Assert.Contains("(\"scout\", \"rg\", \"rg\", \"scout\")", interleaved, StringComparison.Ordinal);
        ...
        Assert.Contains("test_final_failure_uses_singular_retry_context", gateReporterTests, StringComparison.Ordinal);
        Assert.Contains("--workload", gateReporter, StringComparison.Ordinal);
        Assert.Contains("test_initial_failure_can_pass_on_first_retry", gateShellTests, StringComparison.Ordinal);
        Assert.Contains("test_zero_retries_returns_the_initial_failure", gateShellTests, StringComparison.Ordinal);
        Assert.Contains("test_final_failure_uses_singular_retry_context_and_nonzero_exit", gateShellTests, StringComparison.Ordinal);
        ...
        Assert.Contains("uses six valid measured rounds and six warmup", readme, StringComparison.Ordinal);
        Assert.Contains("twelve measured timing samples and three clean RSS", readme, StringComparison.Ordinal);
