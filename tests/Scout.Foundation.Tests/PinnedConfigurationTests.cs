...
public sealed partial class PinnedConfigurationTests
{
    ...
    public void HyperfineBenchSuiteCoversReleaseGateWorkloads()
    {
        ...
        Assert.Contains("GeneratedRecordFactory uses GeneratedRecordBuilder", script, StringComparison.Ordinal);
        ...
        Assert.Contains("same 64 absent literals", readme, StringComparison.Ordinal);
