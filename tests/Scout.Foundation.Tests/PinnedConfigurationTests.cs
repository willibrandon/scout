...
public sealed partial class PinnedConfigurationTests
{
    ...
    public void HyperfineBenchSuiteCoversReleaseGateWorkloads()
    {
        ...
        Assert.Contains("git read-tree --empty", sourceFingerprint, StringComparison.Ordinal);
        Assert.Contains("git write-tree", sourceFingerprint, StringComparison.Ordinal);
        ...
        Assert.Contains("git read-tree --empty", harnessFingerprint, StringComparison.Ordinal);
        Assert.Contains("git write-tree", harnessFingerprint, StringComparison.Ordinal);
        ...
        Assert.Contains("git status --porcelain=v1", performanceGate, StringComparison.Ordinal);
